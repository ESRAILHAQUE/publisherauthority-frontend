...
export default function SupportPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You need a minimum Domain Authority of 20, at least 150-500 monthly organic visitors (depending on DA), an English-language blog updated within the last 90 days, and no subdomains or forum sites.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Earnings depend on your website quality, Domain Authority, traffic, and the number of orders you accept. Higher quality sites earn more per post.",
    },
    {
      question: "Can I reject an order?",
      answer:
        "Yes, you can decline orders that don&apos;t fit your site. However, consistently accepting orders helps build a good relationship with the platform.",
    },
    {
      question: "What happens if I remove a link?",
      answer:
        "Links must stay live permanently. If a link is removed within 1 year, you&apos;ll have 72 hours to restore it, or payment penalties will apply.",
    },
    {
      question: "How do I verify my website?",
      answer:
        "After submitting your website, you&apos;ll receive verification instructions. You can either add a verification tag to your HTML head section or publish a temporary verification article.",
    },
  ];
            ...
            <section className="mb-16 text-center">
              <Card>
                ...
                <a
                  ...
                  className="text-[#2EE6B7] hover:text-primary-purple font-semibold text-lg transition-colors">
  ...
  return (
    <Card>
      <button
        ...
        <svg
          className={`w-5 h-5 text-primary-purple flex-shrink-0 transition-transform duration-200 ${
