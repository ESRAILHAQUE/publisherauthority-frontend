          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                <h2 className="text-2xl font-bold text-primary-purple mb-4 flex items-center gap-2">
                ...
                <ul className="space-y-3 text-gray-700 leading-relaxed ml-10">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Only Website Owners and authors are allowed to register or
                      use this platform.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      and are liable for all activity under their account.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                ...
                <ul className="space-y-3 text-gray-700 leading-relaxed ml-10">
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Access or use the Platform for purposes other than
                      intended.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Sell, transfer, or share their account with others.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Make any unauthorized use of the Platform, including
                      sending unsolicited emails or contacting any vendors or
                      clients.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Harass or intimidate any employees of
                      PublisherAuthority.com.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Create multiple accounts. If multiple accounts are
                      detected, all accounts will be terminated immediately, and
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Publish content on sites not approved in your account.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Replace or modify content provided by
                      PublisherAuthority.com with your own.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                ...
                <p className="text-gray-700 mb-4 ml-10 leading-relaxed">
                  We reserve the right to debit payments for jobs that have
                  already been paid if any of the following issues are
                  identified:
                </p>
                <ul className="space-y-3 text-gray-700 leading-relaxed ml-10">
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      <strong>404 Error:</strong> The link to the job results in
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      <strong>Homepage Redirects:</strong> The link redirects to
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      <strong>Changed Content After Approval:</strong> The
                      content has been altered after approval.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      <strong>No Link in Anchor Text:</strong> The anchor text
              ...
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                ...
                <p className="text-gray-700 leading-relaxed ml-10">
                  ...
                  retract payment if the job is found to be down or has any of
                  the issues listed above due to the publisher&apos;s fault.
                  This may occur before payment is made, and the amount will be
                  withheld or reversed in the next payment cycle.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                ...
                <ul className="space-y-3 text-gray-700 leading-relaxed ml-10">
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      We reserve the right to deactivate your site(s) or account
                      at any time for inappropriate behavior, including but not
                      limited to:
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Users may update site prices within their account;
                      however, current orders in the queue will retain the
                      original price. Future orders will reflect the new price.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      ...
                      payment. Users will receive email notification if an order
                      is canceled.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      review. Late orders will be canceled and removed from the
                      queue, with no payment processed.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      No-Follow links will not be accepted. Orders with
                      No-Follow links will be canceled, no payment will be
                      processed, and the site may be removed.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Affiliate links, subdomain sites, forums/community sites,
                      and sponsored post sites are not accepted. Violating sites
                      will be deactivated.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      We do not accept links that deviate from the original
                      target URL provided.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Price changes for active sites only apply to new jobs.
                      Current jobs retain the original price.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#2EE6B7] mt-1">•</span>
                    <span>
                      Once payment has been successfully received, no disputes
                      or refunds for that payment will be accepted.
                    </span>
                  </li>
                </ul>
              </div>
