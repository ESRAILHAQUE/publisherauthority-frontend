...
export default function BlogPage() {
  const posts = [
    {
      ...
      excerpt: 'Discover the latest SEO strategies that will help your blog content rank higher in search engine results.',
      category: 'SEO',
    ...
    },
    {
      ...
      excerpt: 'Learn about content marketing and sponsored content as effective alternatives to traditional advertising.',
    ...
    },
    {
      ...
      excerpt: 'Everything you need to know about Domain Authority and how to improve yours over time.',
      category: 'SEO',
      date: 'January 5, 2025',
    ...
    },
    {
      ...
      excerpt: 'Compare the benefits of content marketing strategies versus traditional ad-based monetization.',
      category: 'Marketing',
    ...
    },
    {
      ...
      excerpt: 'Essential tips for publishers looking to maximize their earnings through quality guest posting.',
      category: 'Publishing',
    ...
    },
    {
      ...
      excerpt: 'Learn how to track and analyze organic traffic to improve your blog performance.',
      category: 'Analytics',
  ...
  const categories = ['All', 'SEO', 'Monetization', 'Marketing', 'Publishing', 'Analytics'];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Stay updated with the latest insights on SEO, digital marketing, and blog monetization.
            </p>
          </div>
          ...
          <div className="flex justify-center items-center space-x-2">
            ...
            <button className="px-4 py-2 rounded-lg bg-[#3F207F] text-white">1</button>
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors">
              2
            </button>
            <button className="px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors">
