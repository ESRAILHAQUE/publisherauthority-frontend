...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
        ...
        <Card hover>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#3F207F]">{stats.totalPublishers.toLocaleString()}</p>
            </div>
        ...
        <Card hover>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#3F207F]">{stats.totalWebsites.toLocaleString()}</p>
            </div>
        ...
        <Card hover>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#3F207F]">{stats.pendingVerifications}</p>
            </div>
        ...
        <Card hover>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#3F207F]">{stats.activeOrders}</p>
            </div>
        ...
        <Card hover>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#3F207F]">{stats.paymentsQueue}</p>
            </div>
      ...
      {/* Quick Actions */}
      <Card>
        <h2 className="text-xl font-semibold text-[#3F207F] mb-4">Quick Actions</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#3F207F] hover:bg-gray-50 transition-colors text-left">
            <h3 className="font-semibold text-gray-900 mb-1">Verify Websites</h3>
            <p className="text-sm text-gray-600">15 websites pending</p>
          </button>
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#3F207F] hover:bg-gray-50 transition-colors text-left">
            <h3 className="font-semibold text-gray-900 mb-1">Process Payments</h3>
      ...
      {/* Recent Activity */}
      <Card>
        <h2 className="text-xl font-semibold text-[#3F207F] mb-4">Recent Activity</h2>
