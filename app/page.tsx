          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Get Valuable Content, For Free</h3>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Grow Your Traffic</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Monetize Your Blog</h3>
                <p className="text-gray-600 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-base font-bold text-[#E64980]">Step 1:</span>
              ...
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-base font-bold text-[#E64980]">Step 2:</span>
              ...
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-base font-bold text-[#E64980]">Step 3:</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 text-left">
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. What is the minimum Domain Authority you will accept?</p>
                <p className="text-gray-700">A. Domain authority must be 20 or higher</p>
              </div>
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. Will the content we provide contain links?</p>
                <p className="text-gray-700">A. Yes, the average article will contain around 3 links. These links must be set as Do-follow.</p>
              </div>
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. Do you accept all sites?</p>
                <p className="text-gray-700">A. We only accept sites that are written primarily in the English language</p>
              </div>
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. I do not currently have a blog or my blog is outdated is that okay?</p>
              ...
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. Any other URL restrictions?</p>
                <p className="text-gray-700">A. We do not accept Subdomains, forum/community sites, sponsored tags, or guest post advertising.</p>
              </div>
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. Do you accept sites in the XYZ niche?</p>
                <p className="text-gray-700">A. We are open to accepting sites in every niche including grey niches.</p>
              </div>
              <div className="border-l-4 border-[#3F207F] pl-6">
                <p className="font-bold text-lg text-gray-900 mb-2">Q. What is the minimum monthly traffic you will accept?</p>
